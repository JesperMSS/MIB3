...
public class Valideringsklass {
    ...
    public static boolean longPhone(JTextField phoneCheck) {
        ...
        public static boolean longRasSpec(JTextField rasSpecCheck) {
        boolean resultat = true;
        //Kollar så att RasSpec inte är längre än 10 tecken.
        if (rasSpecCheck.getText().length() >= 10) {
            JOptionPane.showMessageDialog(null, "Antal armar/boogies får vara högst 10 tecken lång.");
            resultat = false;
        }
        return resultat;
    }
